...
<html lang="en">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a href="<?php echo base_url('Home/basicbutton'); ?>">Buttons</a></li>
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form class="forms-sample" id="myForm" action="<?php echo base_url('Home/submitForm'); ?>" method="post" style="margin-top: 100px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputLastName1" placeholder="Gender" name="Gender">
                </div>
                <div class="form-group">
                    <label for="exampleInputPosition1">Position</label>
                    <input type="text" class="form-control" id="exampleInputPosition1" placeholder="Position" name="Position">
                </div>
                <div class="form-group">
                    <label for="exampleInputOffice1">Office</label>
                    <input type="text" class="form-control" id="exampleInputOffice1" placeholder="Office" name="Office">
                </div>
                <div class="form-group">
                    <label for="exampleInputAge1">Age</label>
                    <input type="number" class="form-control" id="exampleInputAge1" placeholder="Age" name="Age">
                </div>
                <div class="form-group">
                    <label for="exampleInputStartDate1">Start date</label>
                    <input type="date" class="form-control" id="exampleInputStartDate1" name="Startdate">
                </div>
                <div class="form-group">
                    <label for="exampleInputSalary1">Salary</label>
                    <input type="text" class="form-control" id="exampleInputSalary1" placeholder="Salary" name="Salary">
                </div>
                <div class="form-group">
                    <label for="exampleInputExtn1">Extn.</label>
                    <input type="text" class="form-control" id="exampleInputExtn1" placeholder="Extn." name="Extn">
                </div>
                <div class="form-group">
